...
xpkg.build.provider-testhub: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/testhubs/01-delete.yaml.tmpl.
